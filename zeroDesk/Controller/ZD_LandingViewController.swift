...
class ZD_LandingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        crashBtn?.imageEdgeInsets = UIEdgeInsets.init(top: spacing, left: spacing, bottom: spacing, right: spacing);
        
        feedBackBtn?.layer.cornerRadius = (feedBackBtn?.bounds.height)! / 2;
        feedBackBtn?.imageEdgeInsets = UIEdgeInsets.init(top: spacing, left: spacing, bottom: spacing, right: spacing);
